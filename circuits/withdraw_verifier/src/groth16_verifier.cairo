...
#[starknet::interface]
pub trait IWithdrawGroth16VerifierBN254<TContractState> {
...
#[starknet::contract]
mod WithdrawGroth16VerifierBN254 {
    ...
    #[abi(embed_v0)]
    impl IWithdrawGroth16VerifierBN254 of super::IWithdrawGroth16VerifierBN254<ContractState> {
        fn verify_groth16_proof_bn254(
            self: @ContractState,
            full_proof_with_hints: Span<felt252>,
        ) -> Result<Span<u256>, felt252> {
