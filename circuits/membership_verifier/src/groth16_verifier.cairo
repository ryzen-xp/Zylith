...
#[starknet::interface]
pub trait IMembershipGroth16VerifierBN254<TContractState> {
...
#[starknet::contract]
mod MembershipGroth16VerifierBN254 {
    ...
    const ECIP_OPS_CLASS_HASH: felt252 = 0x312d1dd5f967eaf6f86965e3fa7acbc9d0fbd979066a17721dd913736af2f5e;

    #[storage]
    struct Storage {}

    #[abi(embed_v0)]
    impl IMembershipGroth16VerifierBN254 of super::IMembershipGroth16VerifierBN254<ContractState> {
        // Module renamed to MembershipGroth16VerifierBN254V2 for new class hash
        fn verify_groth16_proof_bn254(
            self: @ContractState,
            full_proof_with_hints: Span<felt252>,
        ) -> Result<Span<u256>, felt252> {
